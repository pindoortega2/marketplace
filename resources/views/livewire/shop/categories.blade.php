                            ...
                            <ul class="menu vertical-menu category-menu">
                                ...
                                @foreach ($categories as $item)
                                    <li>
                                        ...
                                        {{-- haschildre viene de una funcion o metodo del archivo category.php
                                        de los modelos de voyager  si la categoria tiene categorias hijo
                                        imprime l ul caso contrario no lo imprime--}}
                                        @if ($item->haschildren())
                                            <ul class="megamenu">
                                                <li>
                                                            ...
                                                            @if ($child->hasChildren())
                                                                ...
                                                                <ul>
                                                                    @foreach ($child->children() as $item)
                                                                        <li><a href="shop-fullwidth-banner.html">{{$item->name}}</a>
                                                                        </li>                                                            
                                                                    @endforeach                                                                    
                                                                </ul>
                                                            @endif                                                        
